        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.sections.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    ...
                    <!-- Section name -->
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">{{ __() }}</label>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="is_active"
                            ...
                            <option value="1" {{ old('is_active') == 1 ? 'selected' : '' }}>{{ __('keywords.active') }}</option>
                            <option value="0" {{ old('is_active') == 0 ? 'selected' : '' }}>{{ __('keywords.inactive') }}</option>
                        </select>
